...
<sub>Using macOS Big Sur or older? Get the <a href="https://github.com/waydabber/BetterDisplay/releases/download/v1.4.15/BetterDisplay-v1.4.15.dmg">v1.x version</a>. Running <b>macOS Sequoia</b>? Get <a href="https://github.com/waydabber/BetterDisplay/releases/download/v2.0.0-pre-release/BetterDisplay-v2.3.5-b30948-pre-macOS-Sequoia.zip">this pre-release</a>!</sub>
</div>
