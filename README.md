...
<sub>Also available for test-drive: <a href="https://github.com/waydabber/BetterDisplay/releases/tag/v2.0.5-pre-release">the all-new v2.0.5 pre-release</a> version!</sub>
</div>
