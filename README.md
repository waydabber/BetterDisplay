...
<div>
<h2>BetterDummy</h2>
<p>Dummy Display for Apple Silicon/Intel Macs to Have Custom HiDPI Resolutions - an app from one of the maintainers of <a href="https://github.com/MonitorControl/MonitorControl">MonitorControl</a>.<p>
