...
- DDC control using the built-in HDMI port of the 2018 Intel Mac mini is not supported (HDMI ports of all other minis - including M1 and M2 minis - are supported) - for these Macs you need to use a compatible USB-C to DisplayPort or an USB-C to HDMI adapter/cable.
