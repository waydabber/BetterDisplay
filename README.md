...
- There is an additional data collection in form of automatic crash detection and crash log collection starting from BetterDisplay v1.3.15. This data is handled by the third party provider [Sentry](https://sentry.io). You can read about Sentry and Privacy [here](https://sentry.io/trust/privacy/). Crash logs do not contain any personal data but might contain information about the hardware and software environment in which the app runs.
